...
class GetPasskeyActivity : FragmentActivity() {
    ...
    private fun configurePasskeyAssertion(
        ...
        val passkey = credentialRepository.getPasskey(credentialIdEncoded)!!
    ...
    private fun updatePasskeyInCredentialsDataSource(passkeyItem: Passkey) {
        runBlocking {
            credentialRepository.updatePasskey(
                passkeyItem.copy(),
            )
        }
    }
