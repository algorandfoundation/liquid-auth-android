 ...
 *
 */
class PasskeyService(private var serviceRepository: ServiceRepository = AppDependencies.serviceRepository): CredentialProviderService() {
    ...
    override fun onBeginCreateCredentialRequest(
        ...
        val response: BeginCreateCredentialResponse? =
            serviceRepository.processCreateCredentialsRequest(request)
        if (response != null) {
    ...
    override fun onBeginGetCredentialRequest(
                ...
                responseBuilder.setAuthenticationActions(
                    listOf(
                        AuthenticationAction(
                            ...
                            createPendingIntent(
                                serviceRepository.getRequestCounter(),
                                UNLOCK_INTENT,
                            ),
                        ),
                    ),
        ...
        val hasCredentialsFound =
            serviceRepository.processGetCredentialsRequest(request, responseBuilder)
        val hasActionsPopulated =
            populateActions(responseBuilder, serviceRepository.getRequestCounter())
    ...
    companion object {
        private const val OPEN_APP_INTENT = "co.algorand.liquid.OPEN_APP"
        private const val UNLOCK_INTENT = "co.algorand.liquid.UNLOCK_APP"
    }
}
