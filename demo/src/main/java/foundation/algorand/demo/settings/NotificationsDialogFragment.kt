...
class NotificationsDialogFragment(private val packageName: String) : DialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        isCancelable = false // Make the fragment non-cancelable
    }

    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return activity?.let {
            val builder = AlertDialog.Builder(it)
            builder.setMessage("Notifications must be enabled to receive alerts.")
                    ...
                    .setNegativeButton("Exit") { dialog, id -> it.finish() }
    ...
    private fun showDialogAgain() {
        ...
        fragmentTransaction.add(this, "NOTIFICATIONS")
